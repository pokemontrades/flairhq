...
describe("replaceUserURLS", function () {
  it("Replaces /u/test with http://www.reddit.com/u/test", function () {
    ...
    assert.equal(test, '<a href="http://www.reddit.com/u/test"></a>', "Not mapping user urls correctly.")
  });
});
...
describe("replaceSubURLS", function () {
  it("Replaces /u/test with http://www.reddit.com/u/test", function () {
    ...
    assert.equal(test, '<a href="http://www.reddit.com/r/test"></a>', "Not mapping sub urls correctly.")
  });
});