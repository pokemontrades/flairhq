var ptradesFlair = "(([0-9]{4}-){2}[0-9]{4})(, (([0-9]{4}-){2}[0-9]{4}))* \\|\\| ([^ ,|(]*( \\((X|Y|ΩR|αS|S|M|US|UM|LGP|LGE)(, (X|Y|ΩR|αS|S|M|US|UM|LGP|LGE))*\\))?)(, ([^ ,|(]*( \\((X|Y|ΩR|αS|S|M|US|UM|LGP|LGE)(, (X|Y|ΩR|αS|S|M|US|UM|LGP|LGE))*\\))?))*";
var regex = {
